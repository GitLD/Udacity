...
exercised_stock_options = [data_dict[p]['exercised_stock_options'] for p in data_dict if data_dict[p]['exercised_stock_options']!='NaN']
print(max(exercised_stock_options), min(exercised_stock_options))
salary = [data_dict[p]['salary'] for p in data_dict if data_dict[p]['salary']!='NaN']
